...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex flex-col items-center w-full flex-1 bg-[url('https://fundmore.net/assets/img/frontpage/background-img-1.png')]">
          ...
          <div className="container flex flex-wrap flex-col justify-end items-center mx-auto h-full">
            ...
            <div className="flex flex-row justify-end items-center h-full w-10/12">
              ...
              <div className="bg-[#1B7BCC] h-full w-[11%]">
                <img className="h-[70%] p-[10%] pt-[20%] m-auto" src="https://fundmore.net/assets/img/frontpage/mail-icon.png" alt="" />
                <a href="#" className="block h-[30%] text-[12px] pt-[6%] text-white">お問い合わせ</a>
              </div>
              <div className="bg-[#FF65AA] h-full w-[14%]">
                <img className="h-[70%] p-[8%] pr-[30%] m-auto" src="https://fundmore.net/assets/img/frontpage/member-icon.png" alt="" />
